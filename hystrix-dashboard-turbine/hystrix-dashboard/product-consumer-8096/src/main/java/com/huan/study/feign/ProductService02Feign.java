...
import com.huan.study.feign.fallback.ProductServiceFeignFallbackFactory;
 ...
 */
@FeignClient(name = "product-provider", fallbackFactory = ProductServiceFeignFallbackFactory.class)
